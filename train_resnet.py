...
phase1_checkpoint = ModelCheckpoint(
    'models/resnet50_grains_phase1_best.h5',
...
print("\n" + "=" * 60)
print("第二阶段训练：解冻最后10层卷积，小学习率微调")
print("=" * 60)

# 只解冻最后10层，前面全部冻结（100张图不能整网解冻，会瞬间过拟合）
...
print("\n" + "=" * 60)
print("训练完成！")
print(f"第一阶段最佳模型：models/resnet50_grains_phase1_best.h5")
print(f"最终模型（微调后）：models/resnet50_grains.h5")
print("=" * 60)